...
public class Home extends AppCompatActivity {
    ...
    WaitList wait_activity = (WaitList)WaitList.wait_activity;
    //HospitalNfc hospital_activity = (HospitalNfc)HospitalNfc.hospital_activity;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if(wait_activity != null) { wait_activity.finish(); }
        //if(hospital_activity != null) { hospital_activity.finish(); }
        if(submit_activity != null) { submit_activity.finish(); }
...
/*    public void homeWaitListCLicked(View v){
        Intent intent_waitlist = new Intent(getApplicationContext(), WaitList.class);
        startActivity(intent_waitlist);
    }*/
