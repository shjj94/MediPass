        ...
        protected String doInBackground(String... params) {
            ...
            try {
                ...
                if (conn != null) {
                    ...
                    }/*대기인원 출력시 실행*/ else if (params[0].equals(wait_url)) {
                        Log.d(PHP, "if(conn!=null)");
            ...
            if (params[0].equals(wait_url)) {
                wait_num = jsonHtml.toString(); //대기인원 저장
                Log.d(PHP, "wait_num : " + wait_num);
            }
