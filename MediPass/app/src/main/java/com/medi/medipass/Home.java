    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        m_task = new Runnable() {
            ...
            public void run() {
                /*대기인원 업데이트 함수*/
                updateWait();
                m_handler.postDelayed(m_task, 2000);

                final Button bt_receipt = (Button) findViewById(R.id.home_receipt);

                AlertDialog.Builder builder = new AlertDialog.Builder(mContext);

                builder.setTitle("진료안내")
                        .setMessage("진료실로 들어와주세요.")        // 메세지 설정
                ...
                if (wait_num instanceof String) {
                    Log.d("DIALOG", "wait_num(S) :" + wait_num);
                }
                ...
                if (wn.equals("0\n")) {
                    ...
                    Log.d("DIALOG", "show");
                    bt_receipt.setEnabled(true);
                    dialog.show();

                } else {
                    Log.d("DIALOG", "not zero");
                    tv.setText("내 번호\n" + wait_num);
                }
            }
        };
        ...
        hojungNFCReadLibrary = new HojungNFCReadLibrary(getIntent(), Home.this, new OnHojungNFCListener() {
            ...
            public void onReceiveMessage(NfcModel[] models) {
                ...
                try {
                    ...
                    } else if (recptClicked == false && spot.equals("hospital")) {
                        Toast.makeText(Home.this, "접수가 완료되었습니다. 순서를 기다려주세요.", Toast.LENGTH_SHORT).show();
                    } else {
...
//        hojungNFCReadLibrary.onResume(intent);
    ...
    /*내 번호 저장하기*/
    public void myWaitNum() {
        GettingPHP gPHP = new GettingPHP();
        gPHP.execute(my_wait_num_url);
        showWaitNum();
    }
        ...
        protected String doInBackground(String... params) {
            ...
            try {
                ...
                if (conn != null) {
                    ...
                    if (params[0].equals(register_url)) {
                    ...
                    } else if (params[0].equals(wait_url)) {
                        String data = "hospital_code=" + hospital_code + "& my_wait_num=" + my_waitnum;
                        Log.d(PHP, "data " + data);
                    ...
                    } else if (params[0].equals(my_wait_num_url)) {
                        ...
                        Log.d(PHP, "conn" + conn.getResponseCode());
                        if (conn.getResponseCode() == HttpURLConnection.HTTP_OK) {
                            Log.d(PHP, "mynumconn");
                            BufferedReader br = new BufferedReader(new InputStreamReader(conn.getInputStream()));
